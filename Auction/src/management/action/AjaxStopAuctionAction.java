...
public class AjaxStopAuctionAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		System.out.println("AjaxStopAuctionAction --------");
		...
		if(ajaxUpdateDataAuctionBO.stopAuction(detailAuctionInforBean)){
			
			responseMessage(response,"success", "Đã dừng đăng tải");
			return null;
		} 
